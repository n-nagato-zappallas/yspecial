...
if( $self->get('release_date') >= '20210423' ) {
	$arrM = array( '202105', '20210423' );
} else if( $self->get('release_date') >= '20210326' ) {
	$arrM = array( '202104', '20210326' );
} else if( $self->get('release_date') >= '20210220' ) {
	$arrM = array( '202103', '20210220' );
...
//		$SmartyObj->assign( 'list_love', getIndexData( $list_love ) );
		...
		$list_life   = array( 'gt21_004' );
		$list_work   = array( 'gt21_005' );
		$list_meet   = array( 'gt21_006' );
		$list_health = array( 'gt21_007' );
		$SmartyObj->assign( 'list_life', getIndexData( $list_life ) );
		$SmartyObj->assign( 'list_meet', getIndexData( $list_meet ) );
		$SmartyObj->assign( 'list_work', getIndexData( $list_work ) );
